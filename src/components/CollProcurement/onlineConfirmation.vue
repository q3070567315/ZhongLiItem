...
<template>
    <div class="content">
      ...
      <el-card>
        ...
        <el-row :gutter="20">
          <el-col :span="3">
            <el-input placeholder="订单号" clearable>
            </el-input>
          </el-col>
          <el-col :span="3">
            <el-input placeholder="采购员" clearable>
            </el-input>
          </el-col>
          <el-col :span="2">
        ...
        <el-row class="layout_row">
          <!-- 审核按钮 -->
          <el-button class="examine_btn">审核</el-button>
          <el-button class="cancelExamine_btn">取消审核</el-button>
          <!-- 分页功能 -->
          <el-pagination
